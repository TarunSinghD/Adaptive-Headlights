...
#define Counter_2_Resolution            32u
...
#define Counter_2_GetInterruptSource() Counter_2_ReadStatusRegister()
    ...
    void    Counter_2_WriteCounter(uint32 counter) \
            ; 
...
#define Counter_2_INIT_PERIOD_VALUE       4294967295u
...
#else
#define Counter_2_INIT_COMPARE_VALUE      4294967295u
#define Counter_2_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_2_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
 ...
 *************************************/
    ...
    #define Counter_2_RT1_PTR             ( (reg8 *) Counter_2_CounterHW__RT1)
        ...
        #define Counter_2_COUNTER_LSB_PTR     ( (reg8 *)\
            ...
            #define Counter_2_STATICCOUNT_LSB     (*(reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_F0_REG )
            #define Counter_2_STATICCOUNT_LSB_PTR ( (reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_F0_REG )
            #define Counter_2_PERIOD_LSB          (*(reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_D0_REG )
            #define Counter_2_PERIOD_LSB_PTR      ( (reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_D0_REG )
            #define Counter_2_COMPARE_LSB         (*(reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_D1_REG )
            #define Counter_2_COMPARE_LSB_PTR     ( (reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_D1_REG )
            #define Counter_2_COUNTER_LSB         (*(reg16 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_A0_REG )  
            #define Counter_2_COUNTER_LSB_PTR     ( (reg16 *)\
                Counter_2_CounterUDB_sC32_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
        ...
        #define Counter_2_COUNTER_LSB_PTR     ( (reg32 *)\
            ...
            #define Counter_2_STATICCOUNT_LSB     (*(reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_F0_REG )
            #define Counter_2_STATICCOUNT_LSB_PTR ( (reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_F0_REG )
            #define Counter_2_PERIOD_LSB          (*(reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_D0_REG )
            #define Counter_2_PERIOD_LSB_PTR      ( (reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_D0_REG )
            #define Counter_2_COMPARE_LSB         (*(reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_D1_REG )
            #define Counter_2_COMPARE_LSB_PTR     ( (reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_D1_REG )
            #define Counter_2_COUNTER_LSB         (*(reg32 *) \
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_A0_REG )  
            #define Counter_2_COUNTER_LSB_PTR     ( (reg32 *)\
                Counter_2_CounterUDB_sC32_counterdp_u0__32BIT_A0_REG )
    ...
    #define Counter_2_AUX_CONTROLDP0 \
        (*(reg8 *) Counter_2_CounterUDB_sC32_counterdp_u0__DP_AUX_CTL_REG)
    ...
    #define Counter_2_AUX_CONTROLDP0_PTR \
       ...
       #define Counter_2_AUX_CONTROLDP1 \
           (*(reg8 *) Counter_2_CounterUDB_sC32_counterdp_u1__DP_AUX_CTL_REG)
       ...
       #define Counter_2_AUX_CONTROLDP2 \
           (*(reg8 *) Counter_2_CounterUDB_sC32_counterdp_u2__DP_AUX_CTL_REG)
       ...
       #define Counter_2_AUX_CONTROLDP3 \
           (*(reg8 *) Counter_2_CounterUDB_sC32_counterdp_u3__DP_AUX_CTL_REG)
