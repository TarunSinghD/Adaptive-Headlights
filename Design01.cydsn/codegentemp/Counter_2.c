                                   ...
                                   
{
        ...
        Counter_2_GLOBAL_ENABLE &= ((uint8)(~Counter_2_BLOCK_EN_MASK));
    #else
        CY_SET_REG32(Counter_2_COUNTER_LSB_PTR, counter);
    #endif /* (Counter_2_UsingFixedFunction) */
}
#endif /* (!(Counter_2_UsingFixedFunction && (CY_PSOC5A))) */
...
uint32 Counter_2_ReadCounter(void) 
{
    ...
    #if(Counter_2_UsingFixedFunction)
        return ((uint32)CY_GET_REG16(Counter_2_STATICCOUNT_LSB_PTR));
    #else
        return (CY_GET_REG32(Counter_2_STATICCOUNT_LSB_PTR));
    #endif /* (Counter_2_UsingFixedFunction) */
}
...
void Counter_2_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG32(Counter_2_PERIOD_LSB_PTR, period);
    #endif /* (Counter_2_UsingFixedFunction) */
}
...
{
    #if(Counter_2_UsingFixedFunction)
        return ((uint32)CY_GET_REG16(Counter_2_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG32(Counter_2_PERIOD_LSB_PTR));
    #endif /* (Counter_2_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG32(Counter_2_COMPARE_LSB_PTR, compare);
    #endif /* (Counter_2_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG32(Counter_2_COMPARE_LSB_PTR));
}
